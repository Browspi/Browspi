...
class UiElementHandler:
        ...
        for child in dom_element.children:
            if isinstance(child, DOMElementNode):
                ...
                clickable_elements.extend(
                    UiElementHandler.get_clickable_elements(child)
                )
    ...
    def hash_dom_element(dom_element: DOMElementNode) -> str:
        ...
        return UiElementHandler._hash_string(
    ...
    def _attributes_hash(attributes: dict[str, str]) -> str:
        ...
        return UiElementHandler._hash_string(attributes_string)

    @staticmethod
    def _xpath_hash(xpath: str) -> str:
        return UiElementHandler._hash_string(xpath)

    @staticmethod
    def _text_hash(dom_element: DOMElementNode) -> str:
        """ """
        text_string = dom_element.get_all_text_till_next_clickable_element()
        return UiElementHandler._hash_string(text_string)
